...
DEFAULT_REAL_REPOS_DIR = ROOT / "benchmarks" / "real_repos"
...
def main() -> None:
    ...
    if "--cases-dir" not in args:
        args = ["--cases-dir", str(DEFAULT_REAL_REPOS_DIR), *args]
    ...
    if "--strict-expected-files" not in args:
        args = ["--strict-expected-files", *args]
